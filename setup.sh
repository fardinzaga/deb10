...
#install ssh ovpn
wget https://raw.githubusercontent.com/fardinzaga/deb10/master/ssh-vpn.sh && chmod +x ssh-vpn.sh && screen -S ssh-vpn.sh ./ssh-vpn.sh
...
echo "   - Ws SSL/TLS           : 2096"  | tee -a log-install.txt
echo "   - WebSocket            : 2086, 8880, 2082"  | tee -a log-install.txt
echo "   - WsOvpnSsl/NonTls     : 443, 80"  | tee -a log-install.txt
